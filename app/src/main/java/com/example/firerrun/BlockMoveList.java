...
public class BlockMoveList {
    public static int[][][] BlockMove = {
            ...
            {
                    //x,    y,   w,   h,  s,  p1X, p1Y,  w1,  h1, p2X,  p2Y,  w2,  h2
                    {1800, 700, 100, 100, 2, 1800, 700, 100, 100, 2500, 700, 100, 100},
                     //x,    y,   w,   h,  s,  p1X, p1Y,  w1,  h1, p2X,  p2Y,  w2,  h2
                    {5500, 700, 100, 100, 2, 5500, 700, 100, 100, 6300, 700, 100, 100},
